...
import static com.hk.librarycamera2.Camera2Activity.URL;
...
public class PostImageToServer extends AsyncTask<String, String, String> {
    ...
    public PostImageToServer(final Activity context) {
        mContext =context;
    }
    ...
    @Override
        ...
        protected void onPostExecute(String response) {
            ...
            Toast.makeText(mContext, "Back To MainActivity", Toast.LENGTH_SHORT).show();
            mContext.finish();
